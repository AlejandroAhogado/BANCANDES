...
public class GerenteGeneral implements VOGerenteGeneral{
	...
	public GerenteGeneral(String tipoDocumento, int numeroDocumento, String departamento, int codigopostal,
	...
	public String toString() {
		return "GerenteGeneral [tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento
				+ ", departamento=" + departamento + ", codigopostal=" + codigopostal + ", nacionalidad=" + nacionalidad
				+ ", nombre=" + nombre + ", direccion=" + direccion + ", login=" + login + ", contrasena=" + contrasena
				+ ", correo=" + correo + ", telefono=" + telefono + ", ciudad=" + ciudad + ", administrador="
				+ administrador + ", oficina=" + oficina + "]";
	}
